...
<%@ page import="com.ecommerce.dao.UserKeyDAO, com.ecommerce.model.UserKey, com.ecommerce.model.User" %>
<%
...
<div class="container mt-5">
    ...
    <div class="card p-4 shadow-sm">
        ...
        %>
            <div class="mb-3">
                ...
                <p class="mt-2"><strong>Trạng thái:</strong> 
                    <span class="badge bg-success"><%= activeKey.getStatus() %></span>
                </p>
                <p><strong>Ngày tạo:</strong> <%= activeKey.getCreatedAt() %></p>
            </div>
        <%
            } else {
        %>
        ...
        <p class="text-muted mt-2">
            ...
            Public key sẽ được lưu trên hệ thống, Private key sẽ được tải về máy bạn dưới dạng file <code>private.key</code>. 

...
<div class="container mt-5">
    <div class="card p-4 shadow-sm">
        ...
        <p>Đây là mã đại diện cho thông tin đơn hàng của bạn. Bạn sẽ dùng mã này để ký số bằng công cụ riêng.</p>
        ...
        <ol>
            ...
            <li>Chọn file <code>private.key</code> của bạn.</li>
        ...
        <form action="verify-signature" method="post">
            ...
            <button type="submit" class="btn btn-success">✅ Xác nhận và hoàn tất đơn</button>
            <a href="index.jsp" class="btn btn-secondary">Hủy bỏ</a>
        </form>

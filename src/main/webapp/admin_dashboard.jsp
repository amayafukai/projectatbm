...
<%@ page
	import="java.util.*, java.text.*, com.ecommerce.dao.ProductDAO, com.ecommerce.dao.OrderDAO, com.ecommerce.model.Product, com.ecommerce.model.Order"%>
<%
		...
		<div class="row mb-4">
			<div class="col-md-6">
				<div class="card p-3 shadow-sm">
					<h5>
						Total Orders:
						<%=new OrderDAO().getAllOrders().size()%></h5>
				</div>
			</div>
			<div class="col-md-6">
				<div class="card p-3 shadow-sm">
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<%
						String status = o.getVerifyStatus();
						if ("VERIFIED".equals(status)) {
							out.print("✅ Đã xác thực");
						} else {
							out.print("❌ Chờ xác thực");
						}
						%>
					</td>
					<td><a href="verify-order-integrity?orderId=<%=o.getId()%>"
						class="btn btn-sm btn-info">Kiểm tra</a></td>
				</tr>
				<%
				}
				%>
